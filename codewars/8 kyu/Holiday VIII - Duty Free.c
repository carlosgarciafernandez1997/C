...
buy such that the saving over the normal high street price would effectively cover the cost of your holiday.

You will be given the high street price (normPrice), the duty free discount (discount) and the cost of
the holiday.
...
*/
int duty_free(int price, int discount, int holiday_cost) {
  return 100*holiday_cost/(price*discount);
}